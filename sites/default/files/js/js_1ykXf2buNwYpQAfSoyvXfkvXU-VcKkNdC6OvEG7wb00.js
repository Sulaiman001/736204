...
var twitterFeed = {
	...
	options: {
		username: "",
		count: 2,
		URL: "/sites/default/themes/tmwpro/php/twitter-feed.php",
		wrapper: $("#tweet")
	},
	...
	initialize: function( options ) {
		...
		this.options.URL = "/sites/default/themes/tmwpro/php/twitter-feed.php?twitteruser=" + this.options.username + "&notweets=" + this.options.count;
		this.build();
...
Drupal.behaviors.myModuleSecureLink = {
  attach: function (context, settings) {
	$('.page-user .region-content,.page-newsletter .region-content,.search-form').addClass('container');
