 ...
 */
function _professional_is_menu_block($block) {
...
* Js Alter
*/
function professional_css_alter(&$css) {
	if (isset($css['sites/all/libraries/superfish/css/superfish.css'])) {
		unset($css['sites/all/libraries/superfish/css/superfish.css']);
	}
}